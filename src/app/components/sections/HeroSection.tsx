    ...
    <section className="relative isolate z-0 bg-gradient-to-b from-black via-gray-900 to-black text-white overflow-hidden min-h-screen">
      ...
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center justify-between min-h-screen px-6 md:px-12 pt-16 pb-10 z-10">
        <div className="w-full lg:w-1/2 space-y-6 text-center lg:text-left">
          ...
          >
            Hi, I'm <span className="bg-gradient-to-r from-blue-400 to-indigo-500 text-transparent bg-clip-text">Prem Raj</span>
          </motion.h1>
              ...
              items={[
                {
                  ...
                  link: "https://github.com/premrajdev",
                },
                {
                  id: 2,
                  name: "LinkedIn",
                  image: "/svg/linkedin.svg",
                  link: "https://www.linkedin.com/in/premrajdev/",
                },
                {
                  id: 3,
                  name: "Twitter",
                  image: "/svg/twitter.svg",
                  link: "https://twitter.com/premrajcodes",
                },
                {
                  id: 4,
                  name: "Instagram",
                  image: "/svg/instagram.svg",
                  link: "https://www.instagram.com/premraj.codes/",
                },
              ]}
            />
          </div>
          ...
          <div className="flex gap-4 justify-center lg:justify-start mt-6">
            <a href="/PremRaj_CV.pdf" download className="inline-flex items-center gap-2 px-6 py-2 rounded-full text-sm font-semibold bg-blue-600 hover:bg-blue-500 transition">
              <DownloadCloud className="w-4 h-4" />
              Download CV
            </a>
            <a href="#services" className="inline-flex items-center gap-2 px-6 py-2 rounded-full text-sm font-semibold border border-white/20 hover:border-white">
