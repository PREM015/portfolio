...
export default function ProjectComplexityChart() {
  return (
    <motion.section
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 text-lg">
          Explore project complexity chart with detailed insights and interactive elements.
        </p>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-sm text-gray-400">Highlighting an important aspect of this section.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-gray-400">Another significant feature or benefit.</p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-gray-400">Additional value proposition.</p>
          </motion.div>
        </div>
