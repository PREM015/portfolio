...
export default function LiveSocialFeedsSection() {
  return (
    <motion.section
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        >
          Live Social Feeds Section
        </motion.h2>
        
        <p className="text-gray-300 mb-8 text-lg">
          Discover more about live social feeds section and how it enhances your experience.
        </p>
