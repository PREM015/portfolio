...
export default function ReturningVisitorContent() {
  return (
    <motion.section
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 text-lg">
          Discover more about returning visitor content and how it enhances your experience.
        </p>
