...
export default function BeforeAfterCompareSection() {
  return (
    <motion.section
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 text-lg">
          Discover more about before after compare section and how it enhances your experience.
        </p>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-8">
          ...
          >
            ...
            <p className="text-sm text-gray-400">
              Key benefit or feature description goes here.
            </p>
          </motion.div>
          ...
          >
            ...
            <p className="text-sm text-gray-400">
              Another important aspect or value proposition.
            </p>
          </motion.div>
