...
export default function TestimonialCollectionSection() {
  return (
    <motion.section
      ...
      id="testimonialcollectionsection"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 text-lg">
          Discover more about testimonial collection section and how it enhances your experience.
        </p>
