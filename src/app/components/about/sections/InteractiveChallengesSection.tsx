...
export default function InteractiveChallengesSection() {
  return (
    <motion.section
      ...
      id="interactivechallengessection"
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 text-lg">
          Discover more about interactive challenges section and how it enhances your experience.
        </p>
