...
export default function ReferralSourceTracking() {
  return (
    <motion.section
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-gray-300 mb-8 text-lg">
          Discover more about referral source tracking and how it enhances your experience.
        </p>
