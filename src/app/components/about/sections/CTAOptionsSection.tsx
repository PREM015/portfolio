...
export default function CTAOptionsSection() {
  return (
    <motion.section
    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        >
          C T A Options Section
        </motion.h2>

        <p className="text-gray-300 mb-8 text-lg">
          Discover more about c t a options section and how it enhances your experience.
        </p>
