    ...
    content: () => {
      return (
        <p className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base">
          ...
          developers learn web development with practical, real-world projects and clear explanations.
        </p>
      );
    },
  },
    ...
    content: () => {
      return (
        <p className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base">
          ...
          I've built and maintain several npm packages used by the community. My contributions 
          focus on developer tools, UI libraries, and performance utilities.
        </p>
      );
    },
  },
    ...
    content: () => {
      return (
        <p className="text-neutral-600 dark:text-neutral-400 text-sm md:text-base">
          ...
          career guidance. I've helped 20+ developers land their first tech job and transition 
          into full-stack development roles through personalized mentorship programs.
        </p>
      );
    },
  },
